                                ...
                                @foreach ($element as $page => $url)
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page" class="z-10 relative">
                                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-brand-500 border border-brand-500 cursor-default leading-5 dark:bg-brand-600 dark:border-brand-600">{{ $page }}</span>
                                            </span>
                                        @else
