<div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between lg:p-6 border-b border-gray-100 dark:border-gray-800/50">
            <div class="flex-1 max-w-lg">
                <div class="relative w-full">
                    ...
                    <input wire:model.live.debounce.500ms="search" type="text" placeholder="Search cities..." class="pl-11 w-full rounded-xl border border-gray-200 bg-gray-50/50 py-3 text-sm focus:border-blue-500 dark:border-gray-700 dark:bg-white/5 dark:text-white" />
                </div>
            </div>

            <div class="flex items-center gap-3">
                <button x-on:click="$dispatch('open-drawer', 'city-filters')" class="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-white/5 dark:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
    ...
    <!-- Filters -->
    <x-ui.drawer name="city-filters" title="Filter Cities">
        <div class="space-y-6">
            <div>
            ...
            <div>
                ...
                <select wire:model.live="state_id" class="w-full rounded-lg border p-2.5 text-sm dark:bg-white/5">
    ...
    <!-- Delete Modal -->
    <x-ui.modal name="confirm-city-deletion" maxWidth="md">
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white/90">Confirm Deletion</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Are you sure?</p>
            <div class="mt-6 flex justify-end gap-3">
                <x-ui.button variant="secondary" x-on:click="$dispatch('close-modal', 'confirm-city-deletion')">Cancel</x-ui.button>
