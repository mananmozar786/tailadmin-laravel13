<div class="space-y-6">
    <!-- Breadcrumb -->
    <x-common.page-breadcrumb :pageTitle="'Add New Role'" :activePage="'Roles'" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="border-b border-gray-100 px-6 py-4 dark:border-gray-800">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Enter name and assign permissions for the new role.
            </p>
        </div>
            ...
            <div class="pt-6 border-t border-gray-100 dark:border-gray-800">
                ...
                @foreach($permissions as $guard => $perms)
                    <div class="mb-6 last:mb-0">
                        <h5 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">{{ $guard }} Guard</h5>
