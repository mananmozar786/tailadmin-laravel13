<div class="space-y-6">
    <x-common.page-breadcrumb :pageTitle="'Add New Category'" :activePage="'Create'" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <form wire:submit="save" class="space-y-4">
            ...
            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800/50 mt-6">
                ...
                <x-ui.button type="submit" class="rounded-xl px-6 shadow-lg shadow-blue-500/20">Save Category</x-ui.button>
            </div>
        </form>
    </div>
</div>
