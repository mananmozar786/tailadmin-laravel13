<div class="space-y-6">
    <x-common.page-breadcrumb :pageTitle="'State Management'" :activePage="'Create/Edit'" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <form wire:submit="save" class="space-y-4">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium">State Code</label>
                    <input type="text" wire:model="form.state_code" class="w-full rounded-lg border p-2.5 text-sm dark:bg-white/5">
            ...
            <div class="flex justify-end gap-3 pt-4">
                <a href="{{ route('admin.states.index') }}" wire:navigate>
