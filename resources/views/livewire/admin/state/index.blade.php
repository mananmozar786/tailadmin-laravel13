<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between lg:p-6 border-b border-gray-100 dark:border-gray-800/50">
            ...
            <div class="flex items-center gap-3">
                <!-- Filters Button -->
                <button 
                    x-on:click="$dispatch('open-drawer', 'state-filters')"
    ...
    <!-- Filter Drawer -->
    <x-ui.drawer name="state-filters" title="State Filters">
        <div class="space-y-6">
            <!-- Sorting -->
            <div>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-gray-500">Include soft-deleted states</p>
                    </div>
                    <button 
                        type="button"
    ...
    <x-ui.modal name="confirm-state-deletion" maxWidth="md" focusable>
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-800 dark:text-white/90">
                Are you sure you want to delete this state?
            </h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                {{ $showDeleted ? 'This action will permanently delete the state and its associated cities. This cannot be undone.' : 'The state and its associations will be soft-deleted. You can restore them later from the trash.' }}
            </p>

            <div class="mt-6 flex justify-end gap-3">
                <x-ui.button variant="secondary" x-on:click="$dispatch('close-modal', 'confirm-state-deletion')">
                    Cancel
                </x-ui.button>
                <x-ui.button variant="danger" wire:click="delete">
                    {{ $showDeleted ? 'Permanently Delete' : 'Delete State' }}
                </x-ui.button>
            </div>
        </div>
    </x-ui.modal>
