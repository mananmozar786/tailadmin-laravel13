                ...
                <tr class="transition-all hover:bg-gray-50/50 dark:hover:bg-white/[0.02]">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-2">
                            @if($showDeleted)
                                <button wire:click="restore({{ $user->id }})" wire:loading.attr="disabled" class="group flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition hover:border-blue-500 hover:text-blue-500 disabled:opacity-50 dark:border-gray-800 dark:text-gray-400 dark:hover:border-blue-500" title="Restore">
                                ...
                                <button wire:click="confirmDeletion({{ $user->id }})" wire:loading.attr="disabled" class="group flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 text-gray-500 transition hover:border-red-500 hover:text-red-500 disabled:opacity-50 dark:border-gray-800 dark:text-gray-400 dark:hover:border-red-500" title="Force Delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4.5 w-4.5">
